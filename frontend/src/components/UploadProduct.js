...
const UploadProduct = ({
  ...
  return (
    <div className='top-0 bottom-0 left-0 right-0 bg-slate-600 bg-opacity-55 fixed flex justify-center items-center '>
        ...
        <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmitUpload}>
            ...
            <div className='p-2 bg-slate-200 border rounded h-32 w-full flex justify-center items-center cursor-pointer'>               
                    <div className='text-slate-700 flex justify-center items-center flex-col gap-2'>
                        ...
                        <input type='file' id='uploadImageInput' name='productImage' className='hidden' onChange={handleUploadProduct}>
                        </input>
                        </div>               
            </div>
            </label>
            ...
            <button className='px-3 py-2 bg-blue-600 text-white mb-10'>Upload Product</button>
        </form>
        </div>
